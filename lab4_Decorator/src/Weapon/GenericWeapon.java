...
public abstract class GenericWeapon implements TimeObserver {
	...
	/**
	 * fires the weapon if it has ammo or returns 0 if it does not.
	 * subtracts 1 ammo
	 * and then returns the damage based on the calculateDamage(int) method.
	 * @param distance
	 * @return damage
	 */
	...
	/**
	 * shows that a turn has passed and the gun returns to it's max shots remaining
	 * @param time
	 */
